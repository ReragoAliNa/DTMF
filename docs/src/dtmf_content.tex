...
\subsection{综合结果}
项目在 Xilinx ISE 14.7 环境下完成综合与实现。图 \ref{fig:rtl_schematic} 展示了综合后的 RTL 顶层电路结构，图 \ref{fig:resource} 展示了布局布线后的资源占用情况。

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{fpga/fpga_rtl1.png}
    \caption{FPGA 综合电路图 (RTL Schematic)}
